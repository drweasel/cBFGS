...
extern "C"
{
     ...
     */
    bool is_bfgs_success(const BFGS_Result* result);
     ...
     * @param user_ptr a user pointer passed to the function handles (optional)
    ...
    /**
     * Convenience wrapper for bfgs which computes derivates based on the finite
     * difference method.
     *
     * @see bfgs
     */
